...
#
# Generated by Vivado on Tue Oct 25 09:43:16 HKT 2022
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Implementation 2020} -strategy "Performance_EarlyBlockPlacement" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set obj [get_runs impl_1]
set_property -name "constrset" -value "constrs_1" -objects $obj
set_property -name "description" -value "Finalize placement of Block RAM and DSPs in the early stages of global placement." -objects $obj
