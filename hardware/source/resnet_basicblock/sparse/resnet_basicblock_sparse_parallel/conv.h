...
DO_PRAGMA(HLS ARRAY_PARTITION variable=w_buffer cyclic factor=PO/2 dim=2)
...
#pragma HLS PIPELINE II=1
						w_buffer[k][oc * po_factor + po][ic * pi_factor + pi]= w.read();
					}
				}
			}
		}
