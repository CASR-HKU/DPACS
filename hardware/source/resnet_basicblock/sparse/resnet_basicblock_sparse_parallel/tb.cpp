...
int main(){
    ...
    skip_0=0, skip_3=0, skip_1=1, residual=1, stride2=0, use_mask=1;
    enable_pool=0, use_cprune=0, first_layer=0, return_mask=1;
    relu0=1, relu1=1, relu3=1;
    ...
    if (enable_pool)
        w_index = read_file_static<WW, W_FACTOR>(weight_buffer,  OC_1 * OC_1 / CPRUNE_FACTOR, "_fc.txt", w_index);
    if (!skip_0)
