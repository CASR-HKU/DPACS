...
// Elastic linbuffer for second conv 3x3
template<int PI, int BUFFER_WIDTH>
void conv_3x3_line_buffer_residual_serial(
	hls::stream<BundleT<PI, T_F> > &fmap_in,
...
#pragma HLS UNROLL
		...
		// generate bitmap for 3x3 window
		out_empty_check = 0;
...
// Elastic linebuffer with stride 2
template<int PI, int BUFFER_WIDTH>
void conv_3x3_line_buffer_stride_serial(
	hls::stream<BundleT<PI, T_F> > &fmap_in,
	hls::stream<BundleT<PI, T_F> > &fmap_out,
	hls::stream<T_OFFSET > &offset_s,
	hls::stream<T_K > &in_key,
